...
class AdditionInZVM: ObservableObject, CalculationVMProtocol {
    ...
    func saveModel(context: ModelContext) -> Bool {
        ...
        if model == nil {
            model = AdditionInZ(a: a, b: b, n: n, result: result)
        } else {
